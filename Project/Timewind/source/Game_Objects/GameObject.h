...
public:
	...
	*/
	...
	/*!
		\brief
			Returns whether the object should be drawn this frame and have rendering turned off next frame

		\return
			The draw this frame variable
	*/
	/*************************************************************************************************/
	bool GetDrawThisFrame() { return drawThisFrame; }
